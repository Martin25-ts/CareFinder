        ...
        <div class="login">
                ...
                <form method="POST" action="/login">
                    ...
                    <div class="email">
                        ...
                        <input type="text" name="email" id="email" placeholder="Email atau No Telepon" value={{Cookie::get('mycookie') !== null ? Cookie::get('mycookie') : ""}} @required(true)>
                    ...
                    <div class="sandi">
                        ...
                        <input type="password" name="password" id="password" placeholder="Kata Sandi" value={{Cookie::get('mypassword') !== null ? Cookie::get('mypassword') : ""}} @@required(true)>
